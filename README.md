...
channel_stats_chart.svg?v=1788760884
performance_report.html?v=1788760884

### Performance Chart
![Performance Chart](assets/channel_stats_chart.svg?v=1788760884)

### Performance Report
[View Report](assets/performance_report.html?v=1788760884)
...
xychart-beta
    ...
    x-axis ["TheSpeedX/PROXY-List", "proxifly/free-proxy-list", "ProxyScrape", "Previous scan (re-checked)", "ALIILAPRO/Proxy", "monosans/proxy-list", "roosterkid/openproxylist"]
    y-axis "Healthy proxies"
    bar [78, 76, 66, 48, 25, 22, 1]
```
