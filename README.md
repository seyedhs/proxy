...
channel_stats_chart.svg?v=1788717791
performance_report.html?v=1788717791

### Performance Chart
![Performance Chart](assets/channel_stats_chart.svg?v=1788717791)

### Performance Report
[View Report](assets/performance_report.html?v=1788717791)
...
xychart-beta
    ...
    x-axis ["TheSpeedX/PROXY-List", "ProxyScrape", "proxifly/free-proxy-list", "Previous scan (re-checked)", "ALIILAPRO/Proxy", "monosans/proxy-list", "roosterkid/openproxylist"]
    y-axis "Healthy proxies"
    bar [75, 68, 54, 44, 28, 28, 1]
```
