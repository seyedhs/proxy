...
channel_stats_chart.svg?v=1788242512
performance_report.html?v=1788242512

### Performance Chart
![Performance Chart](assets/channel_stats_chart.svg?v=1788242512)

### Performance Report
[View Report](assets/performance_report.html?v=1788242512)
...
xychart-beta
    ...
    x-axis ["ProxyScrape", "TheSpeedX/PROXY-List", "monosans/proxy-list", "Previous scan (re-checked)", "proxifly/free-proxy-list", "ALIILAPRO/Proxy"]
    y-axis "Healthy proxies"
    bar [71, 47, 44, 42, 41, 19]
```
