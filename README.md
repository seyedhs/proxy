...
channel_stats_chart.svg?v=1790056882
performance_report.html?v=1790056882

### Performance Chart
![Performance Chart](assets/channel_stats_chart.svg?v=1790056882)

### Performance Report
[View Report](assets/performance_report.html?v=1790056882)
...
xychart-beta
    ...
    x-axis ["monosans/proxy-list", "proxifly/free-proxy-list", "Previous scan (re-checked)", "TheSpeedX/PROXY-List", "ProxyScrape", "ALIILAPRO/Proxy", "roosterkid/openproxylist"]
    y-axis "Healthy proxies"
    bar [57, 53, 50, 40, 20, 11, 1]
```
