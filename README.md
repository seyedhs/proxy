...
channel_stats_chart.svg?v=1789322522
performance_report.html?v=1789322522

### Performance Chart
![Performance Chart](assets/channel_stats_chart.svg?v=1789322522)

### Performance Report
[View Report](assets/performance_report.html?v=1789322522)
...
xychart-beta
    ...
    x-axis ["ProxyScrape", "TheSpeedX/PROXY-List", "ALIILAPRO/Proxy", "monosans/proxy-list", "Previous scan (re-checked)", "proxifly/free-proxy-list"]
    y-axis "Healthy proxies"
    bar [48, 45, 42, 33, 23, 17]
```
