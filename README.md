...
channel_stats_chart.svg?v=1789948936
performance_report.html?v=1789948936

### Performance Chart
![Performance Chart](assets/channel_stats_chart.svg?v=1789948936)

### Performance Report
[View Report](assets/performance_report.html?v=1789948936)
...
xychart-beta
    ...
    x-axis ["proxifly/free-proxy-list", "monosans/proxy-list", "Previous scan (re-checked)", "TheSpeedX/PROXY-List", "ProxyScrape", "ALIILAPRO/Proxy", "roosterkid/openproxylist"]
    y-axis "Healthy proxies"
    bar [62, 43, 38, 34, 19, 19, 1]
```
